...
void Crsplinetrajectory::calcPoints(point& p0, point& p1, point& p2, point& p3, float& s){
    ...
    if(closed){ //geschlossene Kurve
        ...
        //select points from vector:--> index for vector
        ip1 = (int)s;    //startpunkt des aktuellen Stücks
    ...
    s = s- (int)s;  //s zwischen 0 und 1

    //std::cout << "p0: " << ip0 << " p1: " << ip1 << " p2: " << ip2 << " p3: " << ip3 << " t: " << t << std::endl; 
